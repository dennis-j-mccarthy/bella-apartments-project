...
const features: Feature[] = [
  {
    ...
    image: '/images/placeholder-cabinets.jpg',
    category: 'Interior',
    differentiator: {
      label: 'More Space',
  ...
  },
  {
    ...
    image: '/images/placeholder-washer.jpg',
    category: 'Appliances',
  },
  {
    id: 21,
    title: 'Covered Parking',
    description: 'Protected garage parking spaces keeping your vehicle safe from Florida sun and weather.',
    image: '/images/placeholder-parking.jpg',
    category: 'Building',
    differentiator: {
      label: 'Safe & Protected',
      comparison: 'The brightly lit parking lot keeps you safe while protecting your car from the Florida elements, including the hot sun and frequent summer and fall storms.',
    },
  },
  {
    id: 4,
    ...
    image: '/images/placeholder-closets.jpg',
    category: 'Interior',
  },
  {
    id: 5,
    ...
    image: '/images/placeholder-cooling.jpg',
    category: 'Systems',
    differentiator: {
      label: 'Whisper Quiet',
  ...
  },
  {
    ...
    image: '/images/placeholder-dishwasher.jpg',
    category: 'Appliances',
  },
  {
    id: 7,
    ...
    image: '/images/placeholder-closet-system.jpg',
    category: 'Interior',
    differentiator: {
  ...
  },
  {
    ...
    image: '/images/placeholder-water.jpg',
    category: 'Appliances',
    differentiator: {
  ...
  },
  {
    ...
    image: '/images/placeholder-concrete.jpg',
    category: 'Interior',
    differentiator: {
      label: 'Sound & Style',
  ...
  },
  {
    ...
    image: '/images/placeholder-sink.jpg',
    category: 'Interior',
  },
  {
    id: 13,
    ...
    image: '/images/placeholder-counter.jpg',
    category: 'Interior',
  },
  {
    id: 14,
    ...
    image: '/images/placeholder-balcony.jpg',
    category: 'Outdoor',
  },
  {
    id: 15,
    title: 'Elevator Access',
    description: 'Modern, efficient elevator providing convenient access to all floors with smooth, quiet operation.',
    image: '/images/placeholder-elevator.jpg',
    category: 'Building',
    differentiator: {
      label: 'Essential Convenience',
      comparison: 'Surprisingly, some apartment complexes in Southwest Florida still lack elevators, forcing residents to haul groceries, furniture, and belongings up and down multiple flights of stairs. Bella includes a convenient elevator directly accessible from the enclosed parking area, making move-ins, daily life, and everything in between effortless.',
    },
  },
  {
    id: 16,
    title: 'Additional Storage',
    description: 'Climate-controlled storage units available for rent, perfect for seasonal items and extra belongings.',
    image: '/images/placeholder-storage-unit.jpg',
    category: 'Building',
    differentiator: {
      label: 'On-Site Convenience',
      comparison: 'In Florida, living situations are constantly changing - whether it\'s seasonal residents, snowbirds, or people in transition. These convenient on-site storage units are available for rent right in your building, giving you flexibility for seasonal items and extra belongings without needing to pay for off-site storage facilities or make trips across town.',
    },
  },
  {
    id: 17,
    title: 'Poolside BBQ',
    description: 'Professional-grade outdoor barbecue area by the resort-style pool, ideal for entertaining.',
    image: '/images/placeholder-bbq.jpg',
    category: 'Amenity',
  },
  {
    id: 18,
    title: '24/7 Security',
    description: 'Comprehensive security system with cameras and monitored access points ensuring peace of mind.',
    image: '/images/placeholder-security.jpg',
    category: 'Building',
  },
  {
    id: 19,
    title: 'Keyless Entry',
    description: 'Modern keyless access system for both building and individual residences with smartphone integration.',
    image: '/images/placeholder-keyless.jpg',
    category: 'Technology',
  },
  {
    id: 20,
    title: 'Bike Storage',
    description: 'Secure, covered bike racks encouraging an active lifestyle and sustainable transportation.',
    image: '/images/placeholder-bikes.jpg',
    category: 'Building',
  },
];
